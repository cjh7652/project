...
$('.banner').on({mouseover:function(){
   ...
   left.css('opacity', '0.3').stop().animate({width: 0}, 500)
    ...
    bottom.stop().animate({height: '50%', opcity:0}, 500)
    top.stop().animate({height: '50%', opcity:0}, 500)
    right.stop().animate({width: '50%', opcity:0}, 500)
    left.stop().animate({width: '50%', opcity:0}, 500)
}})